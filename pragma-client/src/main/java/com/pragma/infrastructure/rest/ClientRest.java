...
public class ClientRest {
	...
	public ResponseEntity<ClientDto<TypeDocument>> save(@ModelAttribute("client") ClientDto<TypeDocument> clientDto,
	...
	public ResponseEntity<ClientDto<TypeDocument>> update(@ModelAttribute("client") ClientDto<TypeDocument> clientDto,
			@RequestParam("fileMysql") MultipartFile multipartFileMysql,
			@RequestParam("fileMongoDB") MultipartFile multipartFileMongoDb) {
		return ResponseEntity.status(HttpStatus.OK).body(clientMapper.toDto(
				clientService.update(clientMapper.toEntity(clientDto), multipartFileMysql, multipartFileMongoDb)));
	}
